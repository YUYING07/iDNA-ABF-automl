...
class DataManager():
    ...
    def load_data(self):
        ...
        self.train_dataset, self.train_label = util_file.read_tsv_data(self.config.path_train_data)
        self.test_dataset, self.test_label = util_file.read_tsv_data(self.config.path_test_data)
