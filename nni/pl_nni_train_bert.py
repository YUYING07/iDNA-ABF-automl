...
def run_training(args):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        monitor='val_F1_epoch', save_top_k=10, mode='max')
    early_stop_callback = EarlyStopping(monitor="val_F1_epoch", min_delta=0.01, patience=100, verbose=False,
                                        mode="max")
...
if __name__ == '__main__':
    ...
    args = load_config.load_default_args('bert')
    args.project_name = 'PL_NNI_test'
